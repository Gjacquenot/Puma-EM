...
\section{Summary of terms for dielectric body}
%
\par
...
& $2C_m^p C_n^q\uvect{n} \cdot \Big(\int_{T_m} \vect{r} \times \int_{T_n} \nabla G$ & $- \vect{r}_n^q \cdot \int_{T_m} \left(\uvect{n} \times \vect{r} \right) \int_{T_n} G$ & $+ \vect{r}_n^q \cdot \int_{T_m} \left(\uvect{n} \times \vect{r}\right) \times \int_{T_n} \nabla G$\\
