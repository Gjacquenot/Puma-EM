...
class dielectricTarget_MoM:
    ...
    def V_EH_plane_computation(self, CFIE, target_mesh, E_0, k_hat, r_ref, w, eps_r, mu_r, list_of_test_edges_numbers):
...
if __name__=="__main__":
    ...
    if CHOICE=="dielectric target":
        ...
        #I_CFIE_gmres = gmres(target_MoM.Z_CFIE, target_MoM.V_CFIE, x0=None, tol=1.0e-03, maxiter=1000, xtype=None, restrt=500, callback=itercount)[0]
