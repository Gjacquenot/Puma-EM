...
def copySources(SHORT_LICENCE, COPYRIGHT, CONTACT, pathToCopyFrom, pathToCopyTo):
    ...
    for sourceFileName in listSourcesToCopy:
        if not os.path.isdir(os.path.join(pathToCopyFrom, sourceFileName)):
            ...
            elif '.f' in sourceFileName or '.sh' in sourceFileName or 'COPYING' in sourceFileName or 'REFERENCES' in sourceFileName or 'GUIDE' in sourceFileName or 'hostfile' in sourceFileName or 'repo' in sourceFileName or '.tex' in sourceFileName or '.bib' in sourceFileName or '.txt' in sourceFileName:
                COPY = True
...
if __name__=="__main__":
    ...
    COPYRIGHT = "Copyright (C) 2016 Idesbald Van den Bosch"
