#!/bin/bash
###############################################################
# script for Ubuntu 8.04 to compile puma-em MoM simulator. #
...
sudo apt-get update
sudo apt-get install g++ g77 libstdc++5 python-dev python-scipy python-matplotlib python-tk openmpi-bin libopenmpi-dev dvipng lapack3 blitz++ gmsh doxygen
# create makefile.inc
cd ..
PUMA_EM_DIR=$PWD
