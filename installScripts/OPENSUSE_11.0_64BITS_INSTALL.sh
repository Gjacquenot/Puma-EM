#!/bin/bash
###############################################################
# script for OpenSuse 11.0 to compile puma-em MoM simulator. #
...
sudo zypper ar -c http://download.opensuse.org/repositories/science/openSUSE_11.0/ science
sudo zypper refresh
sudo zypper install gcc-c++ gcc-fortran autoconf automake make libtool python-devel python-scipy python-matplotlib python-tk openmpi openmpi-devel cvs doxygen
...
sudo cp -r ./blitz /usr/lib64/python2.5/site-packages/scipy/weave/blitz/
