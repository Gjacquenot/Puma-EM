...
sudo zypper refresh
sudo zypper install gcc-c++ libstdc++33-32bit Mesa-32bit gcc-fortran autoconf automake make libtool python-devel python-scipy python-matplotlib python-matplotlib-tk python-tk python-numpy-devel openmpi openmpi-devel cvs doxygen
