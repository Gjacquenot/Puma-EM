...
sudo apt-get update
sudo apt-get install g++ gfortran libstdc++5 autoconf libtool python-dev python-scipy python-matplotlib python-tk openmpi-bin libopenmpi-dev dvipng cvs doxygen
# installing GMSH
